...
public class WingHealthScript : BossSectionHealthController
{
	...
	public override string GetDisplayName() => "Eo's Despair";

	public override void Kill()
	{
		CombatManager.Instance().SpawnEnemy(NumericExtensions.RollDie(0, 3) ? EnemyType.Ghast : EnemyType.Ghoul, transform.position);
