...
public class UIDeathController : MonoBehaviour
{
	...
	private static readonly string[] _standardDeaths =
	{
		"You watch as the blood of your wounds soaks into the thirsty earth",
		"The sun sets on the brittle bones of your parched body",
		"Hungry predators encircle your emaciated remains"
	};
