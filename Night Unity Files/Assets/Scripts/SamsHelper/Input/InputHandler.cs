...
namespace SamsHelper.Input
{
	public class InputHandler : MonoBehaviour
	{
		...
		private static   int                               _screenNumber;
		...
		public static IInputListener GetCurrentListener() => _currentInputListener;
		...
		private void UpdateInputType()
		{
			...
			if (currentInputType == BindingSourceType.None
			 ...
			 || currentInputType == BindingSourceType.UnknownDeviceBindingSource)
			{
				currentInputType = BindingSourceType.KeyBindingSource;
			}
		...
		private class InputPress
		{
			...
			private void CheckDoubleTap()
			{
				...
				if (timeBetweenClicks < DoubleTapDuration && _directionAtLastPress.IsPolarityEqual(_currentInputValue))
				{
			...
			public void CheckPress()
			{
				...
				if (isPressed)
				{
					_held = _currentInputValue.IsPolarityEqual(_lastInputValue);
			...
			public bool WasPressed() => _playerAction?.IsPressed ?? _playerAxis.IsPressed;
