...
public class SpawnTrailController : MonoBehaviour
{
	...
	private static readonly ObjectPool<SpawnTrailController> _spawnPool = new ObjectPool<SpawnTrailController>("Spawn Trails", "Prefabs/Combat/Effects/Spawn Trail");
	...
	private IEnumerator WaitForParticles()
	{
		...
		CombatManager.Instance().SpawnEnemy(_typeToSpawn, transform.position);
