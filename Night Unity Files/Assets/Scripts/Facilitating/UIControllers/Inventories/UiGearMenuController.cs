...
namespace Facilitating.UIControllers
{
	public class UiGearMenuController : Menu, IInputListener
	{
		...
		public void OnInputDown(InputAxis axis, bool isHeld, float direction = 0)
		{
			...
			switch (axis)
			{
				case InputAxis.SwitchTab:
					if (direction < 0)
					{
						InventoryTab.CurrentTab().SelectPreviousTab();
					}
					else
					{
						InventoryTab.CurrentTab().SelectNextTab();
					}
		...
		protected override void Awake()
		{
			...
			{
				_tabParent.FindChildWithName("Crafting").SetActive(false);
			}
		...
		public static TabController RightTab() => _instance._rightTab;

		public static TabController LeftTab() => _instance._leftTab;
		...
		public static bool IsOpen() => _instance != null && MenuStateMachine.CurrentMenu() == _instance;
