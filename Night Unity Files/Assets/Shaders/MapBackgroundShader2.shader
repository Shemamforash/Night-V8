...
Shader "MapBackgroundShader2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_73_0 = ( _Time.y * _TimeScale );
			float2 temp_cast_2 = (-temp_output_73_0).xx;
			...
			float2 temp_cast_4 = (-temp_output_73_0).xx;
			...
			float2 temp_cast_6 = (-temp_output_73_0).xx;
			...
			float2 uv_TexCoord40 = i.uv_texcoord + temp_cast_8;
			float simplePerlin2D48 = snoise( ( uv_TexCoord40 * _Detail ) );
			float2 temp_cast_9 = ((( ( simplePerlin2D48 / temp_output_96_0 ) + ( simplePerlin2D48 / temp_output_97_0 ) + ( simplePerlin2D48 / temp_output_98_0 ) )*0.5 + 0.5)).xx;
			float simplePerlin2D50 = snoise( temp_cast_9 );
			float temp_output_52_0 = ( simplePerlin2D33 + simplePerlin2D50 );
			float2 temp_cast_10 = (temp_output_52_0).xx;
			float2 uv_TexCoord78 = i.uv_texcoord * temp_cast_0 + temp_cast_10;
			float simplePerlin2D77 = snoise( uv_TexCoord78 );
			float2 temp_cast_11 = (temp_output_97_0).xx;
			float2 temp_cast_12 = (temp_output_52_0).xx;
			float2 uv_TexCoord81 = i.uv_texcoord * temp_cast_11 + temp_cast_12;
			float simplePerlin2D83 = snoise( uv_TexCoord81 );
			float2 temp_cast_13 = (temp_output_98_0).xx;
			float2 temp_cast_14 = (temp_output_52_0).xx;
			float2 uv_TexCoord85 = i.uv_texcoord * temp_cast_13 + temp_cast_14;
...
/*ASEBEGIN
Version=15401
7;29;1906;1014;-2234.911;-954.0488;1;True;True
Node;AmplifyShaderEditor.TimeNode;55;-2438.419,964.9684;Float;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;74;-2402.126,1149.649;Float;False;Property;_TimeScale;Time Scale;1;0;Create;True;0;0;False;0;0.1;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;92;-1744.372,1167.348;Float;False;Property;_OctavePower;Octave Power;4;0;Create;True;0;0;False;0;3;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;100;-1339.674,2985.842;Float;False;Property;_Detail;Detail;5;0;Create;True;0;0;False;0;4;8;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;2398.953,1512.563;Float;False;Property;_Sparseness;Sparseness;2;0;Create;True;0;0;False;0;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;3600.692,1209.072;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;MapBackgroundShader2;False;False;False;False;False;True;True;True;True;True;True;True;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;False;0;False;Opaque;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;-1;False;-1;-1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=8B31E39C25821D8DD26860C1608C1D95EB1A6F2D