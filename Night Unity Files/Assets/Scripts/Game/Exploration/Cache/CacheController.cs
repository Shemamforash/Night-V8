...
public class CacheController : MonoBehaviour
{
	...
	public void TryActivateButton(CacheButtonController cacheButtonController)
	{
		...
		if (cacheButtonController == _nextButton)
		{
			ActivateButton();
		}
		else
	...
	public static bool Active() => _instance != null && _instance._active;

	public static bool Started() => _instance != null && _instance._started;
}