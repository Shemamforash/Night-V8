...
namespace SamsHelper.Libraries
{
	public class Graph
	{
		...
		public List<Edge> ComputeMinimumSpanningTree(Func<Node, Node, float> nodeWeightComparator = null) => Pathfinding.MinimumSpanningTree(this, nodeWeightComparator);
		...
		public float MaxDepth() => _maxNodeDepth;
	}
