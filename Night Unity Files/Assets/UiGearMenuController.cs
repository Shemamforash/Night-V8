...
public class UiGearMenuController : Menu, IInputListener
{
    ...
    public class GearUi
    {
        ...
        {
            _dpsText.SetColor(text == "" ? new Color(1, 1, 1, 0f) : _activeColour);
            _dpsText.Text(text);
        }

        public void SetNameText(string text)
        {
            _nameText.SetColor(text == "" ? new Color(1, 1, 1, 0f) : _activeColour);
            _nameText.Text(text);
        }

        public void SetTypeText(string text)
        {
            _typeText.SetColor(text == "" ? new Color(1, 1, 1, 0f) : _activeColour);
            _typeText.Text(text);
        }
