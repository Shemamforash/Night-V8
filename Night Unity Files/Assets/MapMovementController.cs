...
public class MapMovementController : MonoBehaviour, IInputListener
{
    ...
    public void OnInputDown(InputAxis axis, bool isHeld, float direction = 0)
    {
        ...
        foreach (Region r in _availableRegions)
        {
            ...
            if (!Helper.IsPositionInCameraView(potentialPosition)) continue;
    ...
    private void TravelToRegion()
    {
        ...
        if (_currentRegion.GetRegionType() == RegionType.Gate) Assert.IsTrue(_nearestRegion.Depth == _enduranceCost + 1);
