...
public class SpermBehaviour : CanTakeDamage
{
	...
	public override string GetDisplayName() => "Ahna's Bane";
	...
	private IEnumerator Explode()
	{
		...
		for (int i = 0; i < childCount; ++i) Destroy(transform.GetChild(i).GetComponent<TailFollowBehaviour>());
		...
		while (childCount >= 0)
		{
			...
			MaelstromShotBehaviour.CreateBurst(90, childPosition, 1f, false, Random.Range(0, 360));
