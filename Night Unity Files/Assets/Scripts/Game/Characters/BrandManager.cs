...
namespace Game.Characters
{
	public class BrandManager
	{
		...
		public List<Brand> GetActiveBrands() => new List<Brand> {_activeBrandOne, _activeBrandTwo, _activeBrandThree};
		...
		private Brand LoadBrand(XmlNode brandNode)
		{
			...
			string name = brandNode.ParseString("Name");
		...
		{
			if (brand == _activeBrandOne)
			{
				_activeBrandOne = null;
			}
			else if (brand == _activeBrandTwo)
			{
				_activeBrandTwo = null;
			}
