...
namespace EpPathFinding.cs
{
	...
	public class JumpPointParam : ParamBase
	{
		...
		{
			get => CurEndNodeUnWalkableTreatment == EndNodeUnWalkableTreatment.ALLOW;
		...
		{
			get => CurIterationType == IterationType.RECURSIVE;
	...
	{
		private static readonly Stack<JumpSnapshot> stack = new Stack<JumpSnapshot>();
