...
Shader "MapBackgroundShader2"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float simplePerlin2D48 = snoise( i.uv_texcoord );
			float simplePerlin2D35 = snoise( i.uv_texcoord );
			float simplePerlin2D42 = snoise( i.uv_texcoord );
			float2 temp_cast_8 = ((( ( simplePerlin2D48 / temp_output_96_0 ) + ( simplePerlin2D35 / temp_output_97_0 ) + ( simplePerlin2D42 / temp_output_98_0 ) )*0.5 + 0.5)).xx;
...
/*ASEBEGIN
Version=15401
1978;17;1906;1014;-964.2933;-680.5691;1.69934;False;True
Node;AmplifyShaderEditor.TimeNode;55;-2438.419,964.9684;Float;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;74;-2402.126,1149.649;Float;False;Property;_TimeScale;Time Scale;1;0;Create;True;0;0;False;0;0.1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;92;-1744.372,1167.348;Float;False;Property;_OctavePower;Octave Power;4;0;Create;True;0;0;False;0;3;2.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;34;-920.5469,2758.493;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;40;-913.3845,2228.277;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;37;-930.3467,3080.943;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;35;-655.9467,2703.793;Float;False;Simplex2D;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;42;-634.8474,2984.943;Float;False;Simplex2D;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;48;-585.5851,2210.978;Float;False;Simplex2D;1;0;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;46;-369.0137,3067.709;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;38;-367.7135,2729.56;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;10;-242.6283,153.6821;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;41;-376.8011,2408.707;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;2398.953,1512.563;Float;False;Property;_Sparseness;Sparseness;2;0;Create;True;0;0;False;0;10;8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;71;2764.856,1098.798;Float;False;Property;_To;To;3;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=414FFDF00EB723A173661DBB738DB7FE0A238A82