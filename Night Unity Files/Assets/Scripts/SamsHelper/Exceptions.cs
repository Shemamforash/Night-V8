...
namespace SamsHelper
{
	public class Exceptions
	{
		...
		public class AttributeNotRecognisedException : Exception
		{
			...
			public AttributeNotRecognisedException(string attribute) => _attribute = attribute;
		...
		public class UnknownCharacterClassException : Exception
		{
			...
			public UnknownCharacterClassException(string trait) => _trait = trait;
		...
		public class DefaultSelectableNotProvidedForMenu : Exception
		{
			...
			public DefaultSelectableNotProvidedForMenu(string name) => _name = name;
		...
		public class ItemNotInInventoryException : Exception
		{
			...
			public ItemNotInInventoryException(string itemName) => _itemName = itemName;
		...
		public class ResourceDoesNotExistException : Exception
		{
			...
			public ResourceDoesNotExistException(string resourceName) => _resourceName = resourceName;
		...
		public class ResourceAlreadyExistsException : Exception
		{
			...
			public ResourceAlreadyExistsException(string name) => _name = name;
		...
		public class UnknownStateNameException : Exception
		{
			...
			public UnknownStateNameException(string stateName) => _stateName = stateName;
		...
		public class MultipleInstancesOfSingletonException : Exception
		{
			...
			public MultipleInstancesOfSingletonException(Type type) => _type = type;
		...
		public class AttributeContainerAlreadyContainsAttributeException : Exception
		{
			...
			public AttributeContainerAlreadyContainsAttributeException(AttributeType type) => _type = type;
		...
		public class UnknownRegionTypeException : Exception
		{
			...
			public UnknownRegionTypeException(string type) => _type = type;
		...
		public class EnemyTypeDoesNotExistException : Exception
		{
			...
			public EnemyTypeDoesNotExistException(string type) => _type = type;
		...
		public class SkillDoesNotExistException : Exception
		{
			...
			public SkillDoesNotExistException(string type) => _type = type;
		...
		public class InscriptionModificationException : Exception
		{
			...
			public InscriptionModificationException(string name) => _name = name;
		...
		public class StateDoesNotExistException : Exception
		{
			...
			public StateDoesNotExistException(string stateName) => _stateName = stateName;
		...
		public class XmlNodeDoesNotExistException : Exception
		{
			...
			public XmlNodeDoesNotExistException(string nodeName) => _nodeName = nodeName;
		...
		public class NodeHasNoAttributesException : Exception
		{
			...
			public NodeHasNoAttributesException(string nodeName) => _nodeName = nodeName;
		...
		public class NoNodesWithNameException : Exception
		{
			...
			public NoNodesWithNameException(string nodeName) => _nodeName = nodeName;
